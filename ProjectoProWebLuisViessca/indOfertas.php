...
<html lang="en"> 
    ...
    <body>
        <h1 class="title">50% de descuento</h1>
         <br></br>
         <div id="menu">
             <ul>
        ...
        <div class="container">
                   ...
                   <div class="card">
                       <img src="Imagenes/imagenofertas.jpg">
                 <h4>GHIA Monitor LED MG2020</h4>
                 <p>De 19.5 Pulgadas,Resolución 1600 x 900px,Negro</p>
                <a href="loginParaCom.php">Comprar</a> 
            </div>
            <div class="card">
                <img src="Imagenes/imagenofertas3.jpg">
                 <h4>Apple iPhone 8 Plus</h4>
                 <p>64GB,Gold-Fully Desbloqueado</p>
             <a href="loginParaCom.php">Comprar</a> 
            </div>
            <div class="card">
                <img src="Imagenes/imagenofertas2.jpg">
                 <h4>Dron DJI Maveric Air 2</h4>
                 <p>Color Gris, Graba video de hasta 4K 60p en imagenes de 48mp</p>
                 <a href="loginParaCom.php">Comprar</a> 
                 <a 
            </div>
