...
//    $id=$_POST['id'];
    ...
    $apem=$_POST['apem'];
     $direccion=$_POST['direccion'];
      $edad=$_POST['edad'];
       $num=$_POST['num'];
       $query=$connection->prepare ("INSERT INTO clientes (IDNOM,APEP,APEM,DIRECCION,EDAD,NUM)"
               ."VALUES (:idnombre,:apep,:apem,:direccion,:edad,:num)");
     ...
     $query->bindParam("edad", $edad, PDO::PARAM_STR);
      $query->bindParam("num", $num, PDO::PARAM_STR);
       $result=$query->execute();
               ...
               if($result)
               {
               echo '<p class="sucees"> Se Registro </p>'; 
               }
               else
               {
